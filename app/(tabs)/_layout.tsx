...
export default function TabLayout() {
  ...
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: p.accent, tabBarInactiveTintColor: p.subtle, tabBarStyle: { backgroundColor: p.background, borderTopColor: p.border, height: 58 + bottom, paddingTop: 7, paddingBottom: bottom }, tabBarLabelStyle: { fontSize: 11, fontWeight: "700" } }}>
